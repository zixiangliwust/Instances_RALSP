...
R = TypeVar("R")
"""
Module: Local search algorithm
Creator: Zixiang Li, zixiangliwust@gmail.com;`n"""


class LSBase(SingleObjectiveSwarmRoot[S, R]):
    """
    ...
    def __init__(self,
        ...
        super(LSBase, self).__init__(problem=problem)
        self.algorithm_name = "Local search algorithm"
    ...
    def evolve(self) -> None:
        ...
        result = self.comparator.compare(new_solution, self.solution)
        if result == -1:
